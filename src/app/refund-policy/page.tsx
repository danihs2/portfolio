...
export const metadata: Metadata = {
  title: "Refund Policy",
  description: "Refund terms for services provided by Daniel Salas.",
  alternates: { canonical: "/refund-policy" },
  openGraph: {
    title: "Refund Policy | Daniel Salas",
    description:
...
export default function RefundPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Refund Policy applies to services delivered by Daniel Salas through this website and direct client agreements."
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            "Refund requests must be sent in writing to danielhachac@gmail.com with invoice details and a clear reason.",
